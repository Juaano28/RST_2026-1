/*
 * rgb_led.c  - Compatible con ESP32-C6 (LEDC_LOW_SPEED_MODE)
 */
...
void rgb_led_pwm_init(void)
{
    ...
    ledc_ch[0].mode         = LEDC_LOW_SPEED_MODE;  // <-- C6 solo soporta LOW SPEED
    ...
    ledc_timer_config_t ledc_timer = {
        ...
        .freq_hz            = 1000,               // 1 kHz es más estable en C6
